...
ggplot(harassment_model_predictions, aes(harassment_binary, estimate)) +
  geom_jitter(aes(colour = factor(name_of_politician))) +
  facet_wrap(verified ~type_of_account) +
  labs(
    x = "Whether a Tweet contains harassment",
